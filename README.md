...
| [UnfoldCMS](https://github.com/hpakdaman/unfoldcms)                     | Self-hosted CMS built on Laravel 12 + React 19 with REST API v1 and headless mode — use as the content layer for eCommerce sites alongside a dedicated cart (Medusa, WooCommerce). [Website](https://unfoldcms.com) | Laravel |
